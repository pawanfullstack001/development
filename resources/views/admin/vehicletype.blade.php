  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form action="{{ url('admin/add_vehicle_type') }}" method="post">
        {{ csrf_field() }}
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form action="{{ url('admin/edit_vehicle_type') }}" method="post">
          {{ csrf_field() }}
          <div class="form-group">
...
<script>
  ...
  function confirm_delete(){
    window.location.href="{{ url('admin/delete_vehicle_type') }}/"+delete_id;
  }
</script>
@endsection
