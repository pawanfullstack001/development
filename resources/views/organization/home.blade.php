  ...
  <div class="layout-content-body">
    ...
    <div class="card edit-profile-page m-0"> 
      <div class="card-body">
        ...
        @php 
        $lat = Auth::guard('organization')->user()->latitude;
        $lng = Auth::guard('organization')->user()->longitude;
        @endphp
    <div>
        <div class="col-md-12">
        ...
        <script>
            ...
            function initMap() { // Google Map Initialization... 
                map = new google.maps.Map(document.getElementById('map'), {
                    zoom: 4,
                    center: new google.maps.LatLng({{ $userdata['type']['latitude'] }},{{ $userdata['type']['longitude'] }}),
                    mapTypeId: 'terrain'
                });
            }
            ...
            function AddCar(data) {
              if(data.val().type=="{{ $userdata['type']['id'] }}"){
                ...
                var marker = new google.maps.Marker({
                    position: uluru,
                    icon: 'http://15.206.179.136/assets/img/favicon.png',
                    map: map
                });
