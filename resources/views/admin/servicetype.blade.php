  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form action="{{ url('admin/add_service_type') }}" enctype="multipart/form-data" method="post">
        {{ csrf_field() }}
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form action="{{ url('admin/edit_service_type') }}" enctype="multipart/form-data"  method="post">
          {{ csrf_field() }}
...
<script>
  ...
  function confirm_delete(){
    window.location.href="{{ url('admin/delete_service_type') }}/"+delete_id;
  }
