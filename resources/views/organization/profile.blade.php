        ...
        <div class="widget-11-2 card no-border card-condensed no-margin widget-loader-circle d-flex flex-column">
          <div class="p-l-25 p-r-25 p-t-20 p-b-20">
            <div class="mt-2 mb-2">
              ...
              <a href="{{ url('organization/editprofile') }}" class="btn btn-primary btn-cons m-t-10" type="submit">Edit</a>
              <a href="{{ url('organization/changepassword') }}" class="btn btn-info btn-cons m-t-10" type="submit">Change Password</a>
            </div>
          </div>
        </div>
      </div>
