  ...
  <input type="hidden" name="selectcountry" id="selectcountry"/>
      ...
      <div class="fixed-top">
        <div class="row gutter-sm">
          ...
          <form autocomplete="on" id="searchfrm">
              ...
              <h3 style="font-weight: bold;margin-bottom: -15px;">Mira los taxis que hay en tu alrededor</h3>
           ...
           <div class="col-12 col-sm-4 col-md-5 col-lg-5">
            ...
            <div class="col-12 col-sm-4 col-md-2 col-lg-2">
              ...
              <a  class="btn btn-info" href="{{ url('/getroute') }}" >Book Taxi Now</a>
              </div>
            </div> 
            </form>
    ...
    height: auto;">
              ...
              <div class="col-6 col-sm-6 col-md-2 col-lg-2 mt-2">
                ...
                <img src="" id="vehicleimage" style="width: 100%;
    height: auto;">
              </div>            
      ...
      var $target = $('html,body'); 
            ...
            $.ajax({
              ...
              success:function(json){
                ...
                setTimeout(function(){                  
                  $("#profileimage").prop('src',"{{url('/public/files')}}/"+json.profile_pic);
                  $("#vehicleimage").prop('src',"{{url('/public/files')}}/"+json.vehicle_image);
                ...
                $("#profileimage").attr('src',"{{url('/public/files')}}/"+json.profile_pic);
                $("#vehicleimage").attr('src',"{{url('/public/files')}}/"+json.vehicle_image);
