...
class ManagementController extends Controller
{
    public function servicetype(){
        ...
        return view('organization.servicetype',["servicetype"=>$servicetype,"organizationtype"=>$organizationtype]);
    }
    ...
    public function addservicetype(Request $request){
        ...
        $servicetype = Servicetype::insert(["servicetype_id"=>$request['service_typeid'],"organization_id"=>$org_id,"image"=>$image,"name"=>$request['name'],"pax"=>$request['pax'],"accept_ccard"=>$request['accept_ccard']]);
    ...
    public function vehicletype(){
        ...
        return view('organization.vehicletype',["vehicletype"=>$vehicletype,"servicetype"=>$servicetype]);
    }
    ...
    public function organizationtype(){
        ...
        return view('organization.organizationtype',["organization"=>$organization]);
    }
    ...
    public function organization(Request $request){
        ...
        //dd($organizations);
        $organizationtype = organizationtype::where('id','!=',1)->get();
        return view('organization.organization',["organizations"=>$organizations,"organizationtype"=>$organizationtype]);
    }
    ...
    public function addorganization(Request $request){
        ...
        $html = "<h3> username :".$username." , password : ".$password."</h3>";

        $data =  ["email"=>$request["add_organization_email"],"html"=>$html];

        $mail = Mail::send(array(), array(), function ($message) use ($data) {
            $message->to($data['email'])
            ->subject('your emergencytaxi organization panel credentials')
        ...
        Organization::insert(['organization_name'=>$request->organization_name,"email"=>$request["add_organization_email"],"type"=>$request["organization_type"],"address"=>$request["add_organization_address"],"phone_no"=>$request["add_organization_phone_no"],"mobile_no"=>$request["add_organization_mobile_no"],"rut"=>$request["add_organization_rut"],"manager_name"=>$request["add_organization_manager_name"],"manager_mobile"=>$request["add_organization_manager_mobile"],
    ...
    public function subadmin(){
        ...
        return view('organization.subadmin',["subadmins"=>$subadmin,'permissions'=>$permissions]);
    }
