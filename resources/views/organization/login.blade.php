  ...
  <body class="fixed-header ">
    <div class="login-wrapper ">
      ...
      <div class="bg-pic">
        ...
        <img src="{{ asset('assets/img/demo/emergency_org_login_bg.png') }}" data-src="{{ asset('assets/img/demo/emergency_org_login_bg.png') }}" data-src-retina="{{ asset('assets/img/demo/emergency_org_login_bg.png') }}" alt="" class="lazy">
        <!-- END Background Pic-->
        ...
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          ...
          <form id="form-login" method="post" class="p-t-15" role="form">
            ...
            <div class="form-group">
                ...
                <a href="{{ url('organization/forgetpassword') }}" class="text-info pull-right">Forgot Password</a>
            </div>
            <!-- END Form Control-->
