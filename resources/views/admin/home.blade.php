        ...
        <div class="row gutter-sm">
          ...
          <!-- <form autocomplete="on" id="searchfrm">
              <div class="form-group">
                <label class="control-label bold-text">From</label>
                <input type="text" id="txtSource"  class="form-control" autocomplete="off" />
              </div>
            </div>
            <div class="col-12 col-sm-4 col-md-5 col-lg-5">
              <div class="form-group">
                <label class="control-label bold-text">To</label>
            ...
            <div class="col-12 col-sm-4 col-md-2 col-lg-2">
              <div class="form-group" style="margin-bottom: 5px;">
               ...
               <button onclick="GetRoute()" class="btn btn-info" >Get Route</button>
              </div>
            </div>
            </form> -->
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            <div class="row mt-2" id="driver_details">
              <div class="col-12 col-sm-4 col-md-3 col-lg-4 mt-2">
                <p><span class="bold-text"> Name : </span><span id="driver_name"></span> &nbsp;<span class="bold-text"> Vehicle No. : </span><span id="driver_vehicle_type"></span></p>
                <p><span class="bold-text"> No Of Passenger : </span><span id="driver_passenger"></span> &nbsp;<span class="bold-text"> Credit Card : </span><span id="driver_credit_card"></span></p>

              </div>
              <div class="col-6 col-sm-6 col-md-2 col-lg-2 mt-2">
                <p><span class="bold-text"> Profile imagee </span></p>
                <img src="" alt="profile image" id="profileimage" style="width: 130px;height: 80px;" title="profile image">
              </div>

              <div class="col-6 col-sm-6 col-md-2 col-lg-2 mt-2">
                <p><span class="bold-text"> Vehicle image </span></p>
                <img src="" alt="vehicle image" id="vehicleimage" style="width: 130px;height: 80px;" title="vehicle image">
              </div>
      ...
      var $target = $('html,body'); 
            ...
            $.ajax({
              ...
              success:function(json){
                ...
                $("#driver_vehicle_type").text(json.vehicle_type);
                $("#driver_passenger").text(json.passengers);
                $("#driver_credit_card").text((json.accept_credit_card)?'Yes':'No');
                ...
                //$("#profileimage").attr('src',"{{ asset('public/files') }}/"+json.profile_pic);
                //$("#vehicleimage").attr('src',"{{ asset('public/files') }}/"+json.vehicle_image);
